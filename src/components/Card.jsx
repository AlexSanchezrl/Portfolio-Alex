...
<div className="border rounded-xl bg-color-card  shadow-md shadow-gray-800 ">
    ...
    <div className="m-4 p-4 flex justify-center">
        <Link to="https://www.google.com/" target='_blanket' class="flex items-center font-bold font-forAll text-md border-2 border-black  p-3 m-3 rounded-xl transition duration-300 hover:bg-orange-600 hover:text-white hover:border-gray-800 hover:shadow-lg hover:shadow-gray-800">
